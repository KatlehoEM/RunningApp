...
import com.example.a2020102527_main_project_2.ui.utils.component.DropDownList
...
/*
    The RunningHistoryScreen composable displays a list of running activities.
    It includes a top app bar with sorting options and navigation controls.
    The list is paginated and supports dynamic loading. Each activity item is represented as a card,
    showing basic information about the run. It also provides a dialog for detailed
    run information and deletion.
 */
@Composable
