...
/*
    This code defines the UI for an onboarding screen in a fitness app.
    It allows users to input their name, gender, weight, and weekly goal distance across multiple pages.
    The screen features navigation buttons for moving between pages and a "Get Started"
    button for completing the onboarding process. Users can navigate back and forth between pages,
    and the UI dynamically updates based on user input.
 */
