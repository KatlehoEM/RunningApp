...
/*
    RunUtils is an object providing various utility functions for managing running activities in Android apps:

    Permission Handling: Checks, requests, and manages location and notification permissions.

    Time Formatting: Converts milliseconds to formatted stopwatch time.

    Distance Calculation: Calculates distance between geographical points and total distance covered.

    Snapshot Generation: Generates map snapshots based on path points and user-defined parameters.

    Miscellaneous: Provides functions for finding the last and first location points, displaying dates, and calculating burnt calories based on weight and distance.
 */
object RunUtils {
